...
{{--                                                    <td>{{ $order->duration }}</td>--}}
                                                    ...
                                                    \Carbon\Carbon::parse
                                                    ($order->enteredTime)
                                                    ->setTimezone('America/New_York')->format('Y-m-d g:i:s A') }}</small></td>
{{--                                                    <td>{{ \Carbon\Carbon::parse($order->closeTime)->format('g:i:s a') }}</td>--}}
                                                    <td nowrap><small>{{
                                                    \Carbon\Carbon::parse($order->closeTime)->setTimezone('America/New_York')->format('Y-m-d g:i:s A') }}</small></td>
